...
//
// МЕХАНІКА. Розмова з NPC -- звичайний тред моста з родом "npc": дім --
// база бота, вебхук пише від імені NPC, гравець ЧИТАЄ її тим самим чатом,
// що й людей. ПЕЙДЖЕР ОДНОСТОРОННІЙ (ТЗ-4 R-G2.4): гравець NPC не
// відповідає -- міст відмовляє, сторінка чату показує розмову як
// «лише читання» (STR_OZ_CHAT_PAGER_RO). Раніше цей заголовок обіцяв
// відповіді, яких ніколи не було. Історію NPC-розмові клієнт НЕ
// довантажує: діалог скриптовий, його ведуть, а не гортають.
//
