...
class OZ_PdaPageContacts : OZ_PdaPage
{
    ...
    private string Detail(OZ_ContactEntry e)
    {
        ...
        // хто в фракції старший -- справа фракції, і видно це в її половині
        // вкладки. Контакти кажуть, ХТО людина: ім'я, фракція, сталкерське
        // звання й мітки. Внутрішня драбина чужої групи в записник не
        // потрапляє навіть підписом.
        if (e.Rank != "")
            line = e.Rank;
